...
function checkTableData(){
    ...
    // }
        ...
        if(checkBlank["0"]==true){
            ...
            errArry.push('Column "B" cannot be blank, if column "A & C" are filled')
            ...
            if(blankCell.length>0){
                errArry.push("There are some blank cells in column "+ removeDuplicates(blankCell))
                ...
                if(u_regex_arr.length==0 ){
                    //////check user name
                    if (duplicates != "") { 
                        errArry.push("<b>Duplicate value found : </b> <span style='word-break: break-all;'>" + duplicates + "</span>")
                        ...
                        if(eArr.length==0){
                            ///////email column check
                            if (duplicates1 != "") { 
                                errArry.push("<b>Duplicate value found : </b><span style='word-break: break-all;'>" + "   " + duplicates1.slice(0, 5) + "... </span>")
                            ...
                            // console.log("hii")
                            errArry.push("<b>Some email Ids are not valid in the selected email column: </b><span style='word-break: break-all;'>" + "   " + eArr.slice(0, 5) + "... </span>")
                    ...
                    errArry.push("<b>Invalid or Blank Username* : </b><span style='word-break: break-all;'>" + "   " + u_regex_arr.slice(0, 5) + "... </span><br/><b>* Usernames can be either valid Email Id or unique alphanumeric words contains only  (@ _ . -)  special characters.</b>")
    ...
    //     $("#editTableError").html("<b>Send email field is not selected</b>");
    //     errFlag=true;
    // }else if(sentEmailSel=="yes" && emailColSel==''){
    //     $("#editTableError").html("<b>Identify Email column field is not selected</b>");
    //     errFlag=true;
    // }else if(userColSel==''){
    //     $("#editTableError").html("<b>Identify Username column field is not selected</b>");
    //     errFlag=true;
    // }else if(u_regex_arr.length==0 ){
    //     //////check user name
    //     // for unique name validation
    ...
    //     $("#editTableError").html("<b>These email Ids are not valid : </b><span style='color:black'>" + "   " + eArr.slice(0, 5) + "... </span>");
    //     errFlag=true;
    // }else if(checkBlank["0"]==true){
    //     $("#editTableError").html('Column "A" cannot be blank in Participants tab!!');
    //     errFlag=true;
    // }else if(checkBlank["0"]==false && checkBlank["1"]==true && checkBlank["2"]==false){
    //     $("#editTableError").html('Column "B" cannot be blank. Either empty column "C" or add data in column "B" in  Participants tab');
    //     errFlag=true;
    // }
