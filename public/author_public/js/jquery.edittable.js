// modified to add icons instead of + and -
...
(function ($, window, i) {
    ...
    $.fn.editTable = function (options) {
        ...
        var s = $.extend({
            ...
            defaultth = '<th><a class="addcol icon-button" href="#"><i class="fa fa-plus"></i></a> <a class="delcol icon-button" href="#"><i class="fa fa-minus"></i></a></th>',
            colnumber,
            rownumber,
            reset,
            is_validated = true;
        ...
        function buildRow(data, len) {
            ...
            return $('<tr/>', {
                html: rowcontent + '<td><a class="addrow icon-button" href="#"><i class="fa fa-plus"></i></a> <a class="delrow icon-button" href="#"><i class="fa fa-minus"></i></a></td>'
            });
        ...
        ///// customized function 
        $table.on('keypress keyup click','input[type="text"]',function(){
            let id = $el.attr('id');
            if(id=="takerTblDyn"){
                showTakersError();
        ...
        $table.on('click', '.addrow', function () {
            ...
            let id = $el.attr('id');
            if(id=="takerTblDyn"){
                $("#tblRowCount").html("Total: "+rownumber+" Participants");
                showTakersError();
            }
