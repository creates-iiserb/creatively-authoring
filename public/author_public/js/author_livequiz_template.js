...
$(document).ready(function(){
    $('#section_name').on('change', function() {
        ...
        let secConData= document.getElementById('sectionCon').value;
       
        // console.log(secConData);

        var secCon = JSON.parse(secConData);
...
$(document).ready(function() {
    ...
    $("#btnGetLiveEval").bind("click", function () {
        if(validationCheck()) {
            ...
            }else if(checkTableData()==true){
                $("#nextBtn").attr('disabled', 'disabled');
                $("#backBtn").attr('disabled', 'disabled');
            }else if(checkTableData()==false){
                $("#nextBtn").removeAttr('disabled');
                $("#backBtn").removeAttr('disabled');
            } else{
